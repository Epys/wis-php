...
class Console
{
    ...
    private static $_path_output = "/output";
    ...
    public static function log($msg = null, $codigo = false)
    {
        ...
        // Formateo mensaje
        $msgs = ((new DateTime())->format("H:i:s:u")) . "\tPID" . getmypid() . "\t\t" . self::clean($msg) . "\t" . $codigo;

        // Guardo console
        self::$_console["log"][] = [((new \DateTime())->format("H:i:s:u")) => self::clean($msg)];
    ...
    public static function input($json = null, $codigo = false)
    {
        ...
        // Guardo registros
        self::_putContents(self::$_path_input . date("/Y/m"), self::clean($json), $codigo);
    ...
    public static function output($json = null, $codigo = false)
    {
        ...
        // Guardo console
        self::$_console["output"][] = self::clean($json);

        // Guardo registros
        self::_putContents(self::$_path_output . date("/Y/m"), self::clean($json), $codigo);
    ...
    public static function destruct()
    {
        ...
        if (self::$_console["input"])
            self::_putContents(self::$_path_input . date("/Y/m"), " ");

        if (self::$_console["output"])
            self::_putContents(self::$_path_output . date("/Y/m"), " ");
